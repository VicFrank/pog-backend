<template>
  <div>
    ...
    <b-alert v-if="success != ''" show variant="success" dismissible>Transaction Success!</b-alert>
    <div v-if="loading" class="d-flex justify-content-center mb-3">
      <b-spinner label="Loading..."></b-spinner>
    </div>
    <b-form-input v-model="steamID" placeholder="Enter Steam ID..."></b-form-input>
    <b-button
      type="submit"
      variant="primary"
      class="mt-3"
    ...
    >
      <b-list-group flush>
        ...
        <b-list-group-item>Battle Pass XP: {{playerData.battlePass.total_experience}}</b-list-group-item>
        <b-list-group-item>Battle Pass Tier: {{playerData.battlePass.tier}}</b-list-group-item>
      </b-list-group>
    </b-card>

    <b-card v-if="cosmetics.length > 0" title="Cosmetics">
