...
const testSample = {
  ...
  gameDuration: 919.99377441406,
  teamInfo: {
    DOTA_TEAM_BADGUYS: {
      buildingKills: {
        secondTower: 717.80981445313,
        firstTower: 608.33654785156,
      },
      assists: 0,
      guardianKills: [],
      kills: 0,
    ...
    DOTA_TEAM_GOODGUYS: {
      buildingKills: {
        barracks: 847.74475097656,
        thirdTower: 898.13244628906,
        secondTower: 832.31518554688,
        fourthTower: 908.69653320313,
        firstTower: 444.40991210938,
      },
      assists: 0,
      guardianKills: [],
      kills: 0,
  ...
  playerInfo: {
    "0": {
      ...
      finalInventory: [],
      steamid: "76561198007141460",
      healthDropDuration: 0,
      tpScrollsUsed: 0,
      buildingDamage: 0,
      level: 10,
      abilities: {
        special_bonus_unique_bristleback: 0,
        special_bonus_unique_bristleback_3: 0,
        bristleback_bristleback: 0,
        generic_hidden: 0,
        ability_capture: 1,
        special_bonus_unique_bristleback_2: 0,
        special_bonus_hp_regen_20: 0,
        bristleback_viscous_nasal_goo: 0,
        special_bonus_hp_200: 0,
        bristleback_quill_spray: 0,
        special_bonus_spell_lifesteal_13: 0,
        bristleback_warpath: 0,
        special_bonus_movement_speed_15: 0,
        special_bonus_mp_regen_250: 0,
      },
      kills: 0,
      permanentBuffs: [],
      disconnectEvents: [],
    ...
    "1": {
      ...
      finalPick: "npc_dota_hero_lone_druid",
      denies: 0,
      totalGold: 5161,
      team: "DOTA_TEAM_GOODGUYS",
      heroDamage: 0,
      ...
      level: 10,
      abilities: {
        special_bonus_unique_lone_druid_2: 0,
        lone_druid_spirit_bear: 0,
        special_bonus_unique_lone_druid_7: 0,
        generic_hidden: 0,
        ability_capture: 1,
        lone_druid_savage_roar: 0,
        special_bonus_unique_lone_druid_11: 0,
        lone_druid_true_form: 0,
        special_bonus_hp_200: 0,
        special_bonus_unique_lone_druid_10: 0,
        special_bonus_unique_lone_druid_4: 0,
        special_bonus_unique_lone_druid_8: 0,
        special_bonus_unique_lone_druid_9: 0,
        lone_druid_spirit_link: 0,
      },
      kills: 0,
      permanentBuffs: [],
      disconnectEvents: [],
    ...
    "2": {
      ...
      finalPick: "npc_dota_hero_sniper",
      denies: 0,
      totalGold: 5161,
      team: "DOTA_TEAM_GOODGUYS",
      heroDamage: 0,
      ...
      level: 10,
      abilities: {
        special_bonus_cooldown_reduction_20: 0,
        ability_capture: 1,
        generic_hidden: 0,
        special_bonus_unique_sniper_5: 0,
        special_bonus_unique_sniper_1: 0,
        special_bonus_attack_range_100: 0,
        sniper_headshot: 0,
        special_bonus_attack_damage_15: 0,
        special_bonus_attack_speed_30: 0,
        sniper_shrapnel: 0,
        special_bonus_unique_sniper_2: 0,
        special_bonus_unique_sniper_3: 0,
        sniper_take_aim: 0,
        sniper_assassinate: 0,
      },
      kills: 0,
      permanentBuffs: [],
      disconnectEvents: [],
    ...
    "3": {
      ...
      finalPick: "npc_dota_hero_witch_doctor",
      denies: 0,
      totalGold: 3831,
      team: "DOTA_TEAM_BADGUYS",
      heroDamage: 0,
      ...
      level: 10,
      abilities: {
        special_bonus_armor_5: 0,
        witch_doctor_paralyzing_cask: 0,
        ability_capture: 1,
        special_bonus_attack_damage_60: 0,
        witch_doctor_death_ward: 0,
        witch_doctor_maledict: 0,
        special_bonus_unique_witch_doctor_6: 0,
        special_bonus_unique_witch_doctor_5: 0,
        special_bonus_unique_witch_doctor_3: 0,
        special_bonus_unique_witch_doctor_2: 0,
        special_bonus_unique_witch_doctor_4: 0,
        generic_hidden: 0,
        special_bonus_unique_witch_doctor_1: 0,
        witch_doctor_voodoo_restoration: 0,
      },
      kills: 0,
      permanentBuffs: [],
      disconnectEvents: [],
    ...
    "4": {
      ...
      finalPick: "npc_dota_hero_dark_seer",
      denies: 0,
      totalGold: 3834,
      team: "DOTA_TEAM_BADGUYS",
      heroDamage: 0,
      ...
      level: 10,
      abilities: {
        special_bonus_evasion_10: 0,
        special_bonus_unique_dark_seer_2: 0,
        generic_hidden: 0,
        dark_seer_ion_shell: 0,
        ability_capture: 1,
        special_bonus_unique_dark_seer_3: 0,
        special_bonus_unique_dark_seer_5: 0,
        special_bonus_armor_8: 0,
        special_bonus_unique_dark_seer: 0,
        dark_seer_vacuum: 0,
        dark_seer_surge: 0,
        dark_seer_wall_of_replica: 0,
        special_bonus_unique_dark_seer_4: 0,
        special_bonus_hp_regen_10: 0,
      },
      kills: 0,
      permanentBuffs: [],
      disconnectEvents: [],
    ...
    "5": {
      ...
      finalPick: "npc_dota_hero_disruptor",
      denies: 0,
      totalGold: 3831,
      team: "DOTA_TEAM_BADGUYS",
      heroDamage: 0,
      ...
      level: 10,
      abilities: {
        special_bonus_unique_disruptor_5: 0,
        ability_capture: 1,
        special_bonus_hp_175: 0,
        generic_hidden: 0,
        special_bonus_unique_disruptor_3: 0,
        special_bonus_unique_disruptor_4: 0,
        disruptor_kinetic_field: 0,
        disruptor_static_storm: 0,
        special_bonus_unique_disruptor_6: 0,
        special_bonus_cast_range_125: 0,
        special_bonus_unique_disruptor_2: 0,
        disruptor_thunder_strike: 0,
        special_bonus_unique_disruptor: 0,
        disruptor_glimpse: 0,
      },
      kills: 0,
      permanentBuffs: [],
